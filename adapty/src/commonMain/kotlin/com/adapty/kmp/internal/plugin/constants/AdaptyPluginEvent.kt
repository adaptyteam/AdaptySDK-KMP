...
internal enum class AdaptyPluginEvent(val eventName: String) {
    PAYWALL_VIEW_DID_PERFORM_ACTION("flow_view_did_perform_action"),
    PAYWALL_VIEW_DID_APPEAR("flow_view_did_appear"),
    PAYWALL_VIEW_DID_DISAPPEAR("flow_view_did_disappear"),
    PAYWALL_VIEW_DID_PERFORM_SYSTEM_BACK_ACTION("paywall_view_did_perform_system_back_action"),
    PAYWALL_VIEW_DID_SELECT_PRODUCT("flow_view_did_select_product"),
    PAYWALL_VIEW_DID_START_PURCHASE("flow_view_did_start_purchase"),
    PAYWALL_VIEW_DID_FINISH_PURCHASE("flow_view_did_finish_purchase"),
    PAYWALL_VIEW_DID_FAIL_PURCHASE("flow_view_did_fail_purchase"),
    PAYWALL_VIEW_DID_START_RESTORE("flow_view_did_start_restore"),
    PAYWALL_VIEW_DID_FINISH_RESTORE("flow_view_did_finish_restore"),
    PAYWALL_VIEW_DID_FAIL_RESTORE("flow_view_did_fail_restore"),
    PAYWALL_VIEW_DID_FAIL_RENDERING("flow_view_did_receive_error"),
    PAYWALL_VIEW_DID_FAIL_LOADING_PRODUCTS("flow_view_did_fail_loading_products"),
    PAYWALL_VIEW_DID_FINISH_WEB_PAYMENT_NAVIGATION("flow_view_did_finish_web_payment_navigation"),
