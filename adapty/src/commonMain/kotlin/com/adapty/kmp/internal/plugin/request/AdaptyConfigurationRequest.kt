...
internal data class AdaptyConfigurationRequestData(
    ...
    @SerialName("adapty_attribution_enabled") val adaptyAttributionEnabled: Boolean = false,
    @SerialName("clear_data_on_backup") val appleClearDataOnBackup: Boolean = false,
